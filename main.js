var app = new Vue({
    ...
    data: {
        products: [
            { id: 1, title: "Medium maturing Alligator dill", short_text: 'Large, glossy, and deep purple-black in color.', image: 'images/eggplant1.jpg', desc:{
            ...
            { id: 2, title: "Mid-early dill Gribovsky", short_text: 'Slender and elongated with a vibrant purple skin', image: 'images/eggplant2.jpg', desc:{
                plant:{p1:"Strong sweet taste.",
                       p2:"Very high productivity with good fruit set.",
                       p3:"Early ripening variety."},
                fruit:{f1:"Shelf life of the fruit is 2.5-3 months.",
            ...
            { id: 3, title: "Mid-maturing dill Abundantly leafy", short_text: 'Round, creamy white with lavender streaks', image: 'images/eggplant3.jpg', desc:{
                plant:{p1:"Strong sweet taste.",
                       p2:"Very high productivity with good fruit set.",
                       p3:"Early ripening variety."},
                fruit:{f1:"Shelf life of the fruit is 2.5-3 months.",
            ...
            { id: 4, title: "Medium maturing dill Hercules", short_text: 'Slim, dark purple Asian variety.', image: 'images/eggplant4.jpg', desc:{
                plant:{p1:"Strong sweet taste.",
                       p2:"Very high productivity with good fruit set.",
                       p3:"Early ripening variety."},
                fruit:{f1:"Shelf life of the fruit is 2.5-3 months.",
            ...
            { id: 5, title: "Medium-late Gladiator dill", short_text: 'Striped in shades of violet and white.', image: 'images/eggplant5.jpg', desc:{
                plant:{p1:"Strong sweet taste.",
                       p2:"Very high productivity with good fruit set.",
                       p3:"Early ripening variety."},
                fruit:{f1:"Shelf life of the fruit is 2.5-3 months.",
